...
public class SpringBootDbAdvancedApplication {
    
    private static final Logger log = LoggerFactory.getLogger(SpringBootDbAdvancedApplication.class);


	public static void main(String[] args) {
		SpringApplication.run(SpringBootDbAdvancedApplication.class, args);
	}
